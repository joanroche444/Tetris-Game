...
//This is a class declaration for a custom view named CanvasView which extends View.
class CanvasView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas?) {
        super.onDraw(canvas)
        //It takes a canvas parameter of type Canvas?.
        //The super.onDraw(canvas) calls the onDraw method of the superclass (in this case, View), ensuring any drawing done by the superclass is preserved.
        val tetromino = Paint()
        //These lines create Paint objects for drawing shapes on the canvas.
        ...
        //This draws a rectangle on the canvas representing the level background.
