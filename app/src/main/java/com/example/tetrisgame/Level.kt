...
class Level {
    companion object {
        ...
        // Array representing X-coordinates for grid drawing
        val X = arrayOf(
        ...
        // first two level is hidden
        // Array representing Y-coordinates for grid drawing
        val Y = arrayOf(
        ...
        // reset level
        // Resetting game parameters and clearing the level grid
        fun reset() {
            level = 1
            score = 0
            Tetromino.speed = 500
        ...
        // Check if the game is over by examining the position of the tetromino blocks
       ...
       //  Check for completed rows and remove them, updating the score and level if necessary
        fun checkRows() {
